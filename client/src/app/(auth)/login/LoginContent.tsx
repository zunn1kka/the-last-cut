...
export function LoginContent() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			const errorMessage =
				err.response?.data?.message || 'Ошибка входа. Проверьте email и пароль.'
					...
					<div>
						...
						<div className='relative'>
							...
							<input
								...
								className='w-full pl-10 pr-4 py-3 bg-custom-darker border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all'
